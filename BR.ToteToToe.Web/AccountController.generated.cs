...
namespace BR.ToteToToe.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : BR.ToteToToe.Web.Controllers.AccountController
    {
        ...
        public override System.Web.Mvc.ActionResult Login(BR.ToteToToe.Web.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
