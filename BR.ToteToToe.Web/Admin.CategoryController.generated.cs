...
namespace BR.ToteToToe.Web.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoryController : BR.ToteToToe.Web.Areas.Admin.Controllers.CategoryController
    {
        ...
        public override System.Web.Mvc.ActionResult Index(BR.ToteToToe.Web.Areas.Admin.ViewModels.CategoryViewModel viewModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
        ...
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, BR.ToteToToe.Web.Areas.Admin.ViewModels.CategoryModel viewModel, System.Web.HttpPostedFileBase file);

        public override System.Web.Mvc.ActionResult Create(BR.ToteToToe.Web.Areas.Admin.ViewModels.CategoryModel viewModel, System.Web.HttpPostedFileBase file)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "file", file);
            CreateOverride(callInfo, viewModel, file);
            return callInfo;
        }
        ...
        public override System.Web.Mvc.ActionResult Edit(BR.ToteToToe.Web.Areas.Admin.ViewModels.CategoryModel viewModel, System.Web.HttpPostedFileBase file)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "viewModel", viewModel);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "file", file);
            EditOverride(callInfo, viewModel, file);
            return callInfo;
        }
