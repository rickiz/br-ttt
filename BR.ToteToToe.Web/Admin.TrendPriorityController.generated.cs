...
{
    public partial class TrendPriorityController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TrendPriorityController() { }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TrendPriorityController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TrendPriorityController Actions { get { return MVC.Admin.TrendPriority; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "TrendPriority";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "TrendPriority";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/TrendPriority/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TrendPriorityController : BR.ToteToToe.Web.Areas.Admin.Controllers.TrendPriorityController
    {
        public T4MVC_TrendPriorityController() : base(Dummy.Instance) { }
